========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet Backgroundsubstraction-Cuda
========================================================================

AppWizard a créé cette application Backgroundsubstraction-Cuda pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application Backgroundsubstraction-Cuda.


Backgroundsubstraction-Cuda.vcxproj
...
Backgroundsubstraction-Cuda.vcxproj.filters
...
Backgroundsubstraction-Cuda.cpp
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) Backgroundsubstraction-Cuda.pch et un fichier de type précompilé nommé StdAfx.obj.
